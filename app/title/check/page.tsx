import { Shield, FileCheck, Clock, IndianRupee, AlertTriangle } from 'lucide-react';
  ...
  return (
    <Shell>
      <WaitlistBanner
        ...
        whatHappensNow="Submit your details and you will be notified the moment we open verifications for your district."
      />
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-12">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-green-700/30 bg-green-50 px-3 py-1 text-xs font-medium text-green-800 mb-4">
              <Shield className="w-3.5 h-3.5" /> Expected pricing ₹499 · 24–48 hour turnaround at launch
            </div>
            <h1 className="font-serif text-3xl lg:text-4xl text-ink leading-tight">
              Reserve a title check
            </h1>
            <p className="mt-2 text-ink/70">
              एक घरौनी की जाँच करवाएं। When the service launches, your submission will be processed first — cross-checked against SVAMITVA + state Bhulekh + dispute records. Signed PDF report by email and WhatsApp.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-paper">
        <div className="mx-auto max-w-7xl px-6 py-12 grid lg:grid-cols-[1.4fr_1fr] gap-10 lg:gap-14">
          <div className="rounded-lg border border-ink/10 bg-paper p-7 lg:p-9">
            ...
            <p className="text-sm text-ink/60 mb-7">We hold your spot in the queue. No payment today.</p>
            <LeadForm
              source="title-check-waitlist"
              fields={fields}
              submitLabel="Reserve my spot"
              successHeadline="You are on the list"
              successHeadlineHi="आप सूची में हैं"
              successBody="When title verifications open for your district, you will be among the first contacted. No payment is taken today."
              preSubmit={
                <div className="rounded-md bg-amber-50 border border-amber-200 p-4 text-sm text-amber-900 flex items-start gap-3">
                  <AlertTriangle className="w-4 h-4 mt-0.5 flex-shrink-0" />
                  <div>
                    <div className="font-medium">No payment today.</div>
                    <p className="text-xs mt-1">Title verification launches Q3 2026. When we open in your district we will email you a UPI/Razorpay link. You can cancel anytime before paying.</p>
                  </div>
                </div>
              }
            />
          ...
          <div className="space-y-6">
            <div className="rounded-lg border border-ink/10 bg-ink/[0.015] p-6">
              <div className="text-[11px] uppercase tracking-widest text-terracotta/80 font-medium mb-3">What it will include</div>
            ...
            <div className="text-xs text-ink/55 leading-relaxed">
              <p className="mb-2"><strong className="text-ink/70">Refund policy at launch:</strong> If we cannot verify the card, we refund 100% within 48 hours.</p>
